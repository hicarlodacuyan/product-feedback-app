...
function Header() {
  return (
    <nav className="container mx-auto bg-white flex justify-between items-center p-8">
      <div>
        <Link href="/" className="flex items-center text-gray-700">
          <Image src="/favicon.ico" width={40} height={40} alt="App logo" />
          <h1 className="text-xl font-bold ml-2">Tweeter</h1>
        </Link>
      </div>
      ...
      <div>
        <Link href="/profile" className="flex items-center text-gray-700">
          ...
          <h1 className="font-bold ml-2">John Doe</h1>
        </Link>
      </div>
    </nav>
  );
